...
- The normal website provides public, read-only group browsing and a live leaderboard. Signing in activates only the controls allowed for that account, so separate scoring and leaderboard links are no longer necessary.
