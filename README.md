...
- KPs can be marked during play on holes 2, 8, 12, and 17. The current holder earns the KP tic only after entering par or better. A supplanted claim or a current claim with bogey or worse is marked **KP FAIL** as a transparent red diagonal stamp over the score on live, printed, and exported scorecards, leaving the score legible and awarding 0 tics. A blank score is pending and also receives 0 tics. The sortable KP Fails leaderboard column counts failures without changing anyone's points.
